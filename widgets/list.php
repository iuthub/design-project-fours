<div class="block">
	<form name="search" action="index.php" method="GET">
		...
		<input class="form-control" type="text" name="search_input" placeholder="Quiz search ... "/>
			<div class="input-group-btn">
				<button class="btn btn-default" name="search_quiz" type="submit"><i class="glyphicon glyphicon-search"></i></button>
			</div>
		</div>
	</form>
	<?php
